      ...
      <div className="max-w-xl w-full bg-[#0a0a0a] border border-zinc-900 rounded-2xl overflow-hidden shadow-2xl">
        <div style={{ padding: '20px 20px 0 20px' }}>
          <div style={{ width: '100%', height: '180px', borderRadius: '12px', overflow: 'hidden', backgroundColor: '#111' }}>
            <img src={news?.imageurl} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: '0.9' }} />
          </div>
        </div>
        ...
        <div className="p-6 text-center">
          ...
          <h1 style={{ color: '#ffffff', fontSize: '22px', fontWeight: '900', lineHeight: '1.3', marginBottom: '15px' }}>{news?.title}</h1>
          ...
          <a href={news?.url} target="_blank" rel="noopener noreferrer" style={{ display: 'block', width: '100%', padding: '16px', backgroundColor: '#ea580c', color: '#ffffff', fontWeight: 'bold', borderRadius: '12px', textDecoration: 'none', textTransform: 'uppercase', fontSize: '14px' }}>
            ПЕРЕЙТИ К ИСТОЧНИКУ
          </a>
