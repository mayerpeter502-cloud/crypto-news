...
export default function NewsContent({ id }: { id: string }) {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-start p-4 pt-6 text-white">
      ...
      <div style={{ 
        width: '100%', maxWidth: '600px', height: '90px', backgroundColor: '#111', 
        border: '1px dashed #333', borderRadius: '12px', marginBottom: '20px', 
        display: 'flex', alignItems: 'center', justifyContent: 'center', 
        color: '#888', fontSize: '11px', textTransform: 'uppercase', fontWeight: 'bold' 
      }}>
      ...
      <div className="max-w-xl w-full bg-[#0a0a0a] border border-zinc-900 rounded-2xl overflow-hidden shadow-2xl">
        ...
        {/* КАРТИНКА: Сохранен размер 180px */}
