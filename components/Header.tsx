...
>
  ...
  />
         ...
         <button  
           ...
           // rounded-full: КРУГЛАЯ, h-8 (32px) - Маленькая и аккуратная
           className="flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-all z-[60] shrink-0 h-8"
