...
export default function Header() {
  ...
  return (
    // Возвращаем исходную высоту h-16
    <header className="w-full bg-black border-b border-zinc-900 sticky top-0 z-[100] h-16 flex items-center justify-center">
      <div className="w-[96%] max-w-[1440px] flex items-center justify-between px-4">
        ...
        <div className="flex items-center">
          ...
          {/* СТРОКА ПОИСКА: ml-10 создает четкий отступ от текста LOGO */}
          <div className="relative ml-10 w-[200px] flex items-center">
            <input
              type="text"
              placeholder="Search..."
              value={searchQuery}
            ...
            />
            {/* Кнопка поиска (пока оставляем как есть) */}
            <button 
