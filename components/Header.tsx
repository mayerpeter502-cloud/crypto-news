    ...
    <header className="w-full bg-black border-b border-zinc-900 sticky top-0 z-[100] h-16 flex items-center justify-center">
      <div className="w-[96%] max-w-[1440px] flex items-center justify-between px-4">
        ...
        <div className="flex items-center flex-1">
          ...
          {/* ПОИСК: ml-12 создает принудительный отступ от логотипа */}
          <div className="relative ml-12 w-full max-w-[160px] flex items-center group">
            <input
              type="text"
              placeholder="Search..."
              value={searchQuery}
              ...
              // pr-10 резервирует место под лупу справа
            ...
            />
            {/* КНОПКА ПОИСКА: Используем absolute right-3 и принудительный сброс left */}
            <button 
              onClick={handleSearch}
              style={{ left: 'auto' }} 
              className="absolute right-3 p-1 flex items-center justify-center text-zinc-500 group-focus-within:text-orange-500 hover:text-orange-400 transition-colors"
            >
